...
@javax.annotation.Generated(
    ...
    comments = "Source: bus.proto")
public final class travelDSGrpc {

  private travelDSGrpc() {}

  public static final String SERVICE_NAME = "travelDS.travelDS";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<travelDS.bus.busNumber,
      travelDS.bus.busTimetable> getGetTimetableMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getTimetable",
      requestType = travelDS.bus.busNumber.class,
      responseType = travelDS.bus.busTimetable.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<travelDS.bus.busNumber,
      travelDS.bus.busTimetable> getGetTimetableMethod() {
    io.grpc.MethodDescriptor<travelDS.bus.busNumber, travelDS.bus.busTimetable> getGetTimetableMethod;
      ...
      synchronized (travelDSGrpc.class) {
        if ((getGetTimetableMethod = travelDSGrpc.getGetTimetableMethod) == null) {
          travelDSGrpc.getGetTimetableMethod = getGetTimetableMethod = 
              io.grpc.MethodDescriptor.<travelDS.bus.busNumber, travelDS.bus.busTimetable>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "travelDS.travelDS", "getTimetable"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  travelDS.bus.busNumber.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  travelDS.bus.busTimetable.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<travelDS.bus.busSpecific,
      travelDS.bus.busAmount> getSeeBusMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "seeBus",
      requestType = travelDS.bus.busSpecific.class,
      responseType = travelDS.bus.busAmount.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<travelDS.bus.busSpecific,
      travelDS.bus.busAmount> getSeeBusMethod() {
    io.grpc.MethodDescriptor<travelDS.bus.busSpecific, travelDS.bus.busAmount> getSeeBusMethod;
    if ((getSeeBusMethod = travelDSGrpc.getSeeBusMethod) == null) {
      synchronized (travelDSGrpc.class) {
        if ((getSeeBusMethod = travelDSGrpc.getSeeBusMethod) == null) {
          travelDSGrpc.getSeeBusMethod = getSeeBusMethod = 
              io.grpc.MethodDescriptor.<travelDS.bus.busSpecific, travelDS.bus.busAmount>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "travelDS.travelDS", "seeBus"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  travelDS.bus.busSpecific.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  travelDS.bus.busAmount.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<travelDS.bus.busNumber,
      travelDS.bus.busDelete> getDeleteBusMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "deleteBus",
      requestType = travelDS.bus.busNumber.class,
      responseType = travelDS.bus.busDelete.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<travelDS.bus.busNumber,
      travelDS.bus.busDelete> getDeleteBusMethod() {
    io.grpc.MethodDescriptor<travelDS.bus.busNumber, travelDS.bus.busDelete> getDeleteBusMethod;
    if ((getDeleteBusMethod = travelDSGrpc.getDeleteBusMethod) == null) {
      synchronized (travelDSGrpc.class) {
        if ((getDeleteBusMethod = travelDSGrpc.getDeleteBusMethod) == null) {
          travelDSGrpc.getDeleteBusMethod = getDeleteBusMethod = 
              io.grpc.MethodDescriptor.<travelDS.bus.busNumber, travelDS.bus.busDelete>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  travelDS.bus.busNumber.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  travelDS.bus.busDelete.getDefaultInstance()))
  ...
  public static abstract class travelDSImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getTimetable(travelDS.bus.busNumber request,
        io.grpc.stub.StreamObserver<travelDS.bus.busTimetable> responseObserver) {
     ...
     * </pre>
     */
    public void seeBus(travelDS.bus.busSpecific request,
        io.grpc.stub.StreamObserver<travelDS.bus.busAmount> responseObserver) {
     ...
     * </pre>
     */
    public void deleteBus(travelDS.bus.busNumber request,
        io.grpc.stub.StreamObserver<travelDS.bus.busDelete> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                travelDS.bus.busNumber,
                travelDS.bus.busTimetable>(
                  this, METHODID_GET_TIMETABLE)))
          .addMethod(
            getSeeBusMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                travelDS.bus.busSpecific,
                travelDS.bus.busAmount>(
  ...
  public static final class travelDSBlockingStub extends io.grpc.stub.AbstractStub<travelDSBlockingStub> {
     ...
     * </pre>
     */
    public travelDS.bus.busTimetable getTimetable(travelDS.bus.busNumber request) {
     ...
     * </pre>
     */
    public travelDS.bus.busAmount seeBus(travelDS.bus.busSpecific request) {
      return blockingUnaryCall(
     ...
     * </pre>
     */
    public travelDS.bus.busDelete deleteBus(travelDS.bus.busNumber request) {
      return blockingUnaryCall(
  ...
  public static final class travelDSFutureStub extends io.grpc.stub.AbstractStub<travelDSFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<travelDS.bus.busTimetable> getTimetable(
        travelDS.bus.busNumber request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<travelDS.bus.busAmount> seeBus(
        travelDS.bus.busSpecific request) {
      return futureUnaryCall(
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<travelDS.bus.busDelete> deleteBus(
        travelDS.bus.busNumber request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_TIMETABLE:
          serviceImpl.getTimetable((travelDS.bus.busNumber) request,
              (io.grpc.stub.StreamObserver<travelDS.bus.busTimetable>) responseObserver);
          break;
        case METHODID_SEE_BUS:
          serviceImpl.seeBus((travelDS.bus.busSpecific) request,
              (io.grpc.stub.StreamObserver<travelDS.bus.busAmount>) responseObserver);
          break;
        case METHODID_DELETE_BUS:
          serviceImpl.deleteBus((travelDS.bus.busNumber) request,
              (io.grpc.stub.StreamObserver<travelDS.bus.busDelete>) responseObserver);
          break;
        default:
  ...
  private static abstract class travelDSBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return travelDS.bus.travelDSServiceImpl.getDescriptor();
    }
